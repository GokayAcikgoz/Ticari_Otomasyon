...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSetTableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [TBL_FIRMALAR] ([AD], [YETKILISTATU], [YETKILIADSOYAD], [YETKILITC], [SEKTOR], [TELEFON1], [TELEFON2], [TELEFON3], [MAIL], [FAX], [IL], [ILCE], [VERGIDAIRE], [ADRES]) VALUES (@AD, @YETKILISTATU, @YETKILIADSOYAD, @YETKILITC, @SEKTOR, @TELEFON1, @TELEFON2, @TELEFON3, @MAIL, @FAX, @IL, @ILCE, @VERGIDAIRE, @ADRES);
SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [TBL_FIRMALAR] SET [AD] = @AD, [YETKILISTATU] = @YETKILISTATU, [YETKILIADS" +
                ...
                "ADRES WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([A" +
                ...
                ") OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([FA" +
                "X] = @Original_FAX)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original" +
                "_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) A" +
                "ND ((@IsNull_VERGIDAIRE = 1 AND [VERGIDAIRE] IS NULL) OR ([VERGIDAIRE] = @Origin" +
                "al_VERGIDAIRE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Orig" +
                "inal_ADRES)));\r\nSELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, " +
                "TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES FROM TBL_FI" +
                "RMALAR WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON" +
                "2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES FROM TBL_FIRMALAR";
